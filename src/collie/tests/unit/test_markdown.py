...
class TestMarkdownRendering:
    ...
    def test_card_rendering(self):
        ...
        assert "### E22 · Human-Made Object · Ancient Vase (obj_001)" in markdown
        assert "**Location** (`current_location`): place_001" in markdown
        assert "**Produced By** (`produced_by`): prod_001" in markdown
    ...
    def test_table_rendering(self):
        ...
        entities = [
            E22_HumanMadeObject(id="obj_001", class_code="E22", label="Vase 1"),
            E22_HumanMadeObject(id="obj_002", class_code="E22", label="Vase 2")
        ]
        ...
        assert "| --- | --- | --- | --- |" in markdown
        assert "| obj_001 | E22 | Vase 1 |" in markdown
        assert "| obj_002 | E22 | Vase 2 |" in markdown
    ...
    def test_narrative_rendering(self):
        ...
        assert "that occurred during timespan_001" in markdown
        assert "at place_001" in markdown
    ...
    def test_aliases_usage(self):
        ...
        assert "### E22 · Artifact · Ancient Vase (obj_001)" in markdown
    ...
    def test_empty_entity(self):
        ...
        assert "### E22 · Human-Made Object (obj_001)" in markdown
