...
def _render_card(entity: CRMEntity, aliases: dict[str, str] | None, show_codes: bool) -> str:
...
def _render_detailed(entity: CRMEntity, aliases: dict[str, str] | None, show_codes: bool) -> str:
...
def _render_narrative(entity: CRMEntity, aliases: dict[str, str] | None, show_codes: bool) -> str:
...
def _get_friendly_property_name(property_name: str, aliases: dict[str, str] | None) -> str:
