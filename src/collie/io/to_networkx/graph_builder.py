...
from collie.models.base import CRMEntity, CRMRelation
from collie.extraction.models import ExtractedEntity, ExtractedRelationship, ExtractionResult


def to_networkx_graph(
    entities: List[CRMEntity],
    relationships: Optional[List[CRMRelation]] = None,
    *,
    directed: bool = True,
